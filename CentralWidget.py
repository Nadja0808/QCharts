...
from AktienWidget import AktienWidget
...
class CentralWidget(QWidget):
    ...
    def __init__(self, parent):
        ...
        #WidgetChart im CentralWidget bekannt machen
        ...
        # self.push_button_color = QPushButton("Farbpalette")
        # self.push_button_color.clicked.connect(self.get_color)
        ...
        # self.h_box_layout.addWidget(self.push_button_color)
    ...
    def timer_start(self):
        ...
        #color = QColorDialog.getColor()
        #self.chart_view.change_color(color)
    ...
    def set_temperature_min(self, text):
        self.temperature_min = text
        self.chart_view.set_temperature_range(self.temperature_min, self.temperature_max)

    def set_temperature_max(self, text):
        self.temperature_max = text
        self.chart_view.set_temperature_range(self.temperature_min, self.temperature_max)